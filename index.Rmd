...
**Note**: Informações mais resumidas e exemplos do uso das funções do pacote **iRegression** poderão ser obtidas na url do pacote em [iRegression](https://prdm0.github.io/iRegression/) ou nas documentações no CRAN em [iRegression (CRAN)](http://CRAN.r-project.org/package=iRegression).
